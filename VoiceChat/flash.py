...
import json
sys.path.append("../..")
from VoiceChat.common import credential
from VoiceChat.asr import flash_recognizer

# 注意：使用前务必先填写APPID、SECRET_ID、SECRET_KEY，否则会无法运行！！！
APPID = "1321426220"
SECRET_ID = "AKID6A2h8KSO7bv3A5mEUXR7YmmX3YrxoRs5"
SECRET_KEY = "2pOksldHivt6GJAnEUafXEh6JJ9mDSWN"
ENGINE_TYPE = "16k_zh"
